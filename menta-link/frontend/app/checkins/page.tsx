              ...
              <div className="relative flex items-center justify-between gap-2">
                {[1, 2, 3, 4, 5].map((val) => (
                  <motion.button
                    ...
                    className={cn(
                      'group relative flex h-10 w-10 flex-col items-center justify-center rounded-2xl border-2 transition-all duration-300 min-[400px]:h-12 min-[400px]:w-12 sm:h-14 sm:w-14',
