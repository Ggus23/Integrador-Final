...
class APIClient {
  ...
  async getMySubjectGrades() {
    return this.request('GET', '/academic/subjects/me');
  }

  async saveSubjectGrade(data: Record<string, any>) {
    return this.request('POST', '/academic/subjects/me', data);
  }
  ...
  async getStudentHistory(studentId: string) {
    return this.request('GET', `/students/${studentId}/history`);
  }
