...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'border-sidebar-border bg-sidebar/80 text-sidebar-foreground fixed top-16 left-0 z-50 h-[calc(100vh-4rem)] w-64 border-r backdrop-blur-xl transition-all duration-300 ease-in-out md:translate-x-0',
