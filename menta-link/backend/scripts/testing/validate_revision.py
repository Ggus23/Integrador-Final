...
def test_dropout_correlation():
    ...
    risk = risk_service.calculate_dropout_risk(
        emotional_risk_score=9, failed_classes=3, gpa_drop=False
    )
    ...
    risk = risk_service.calculate_dropout_risk(
        emotional_risk_score=4, failed_classes=0, gpa_drop=False
    )
    ...
    risk = risk_service.calculate_dropout_risk(
        emotional_risk_score=9, failed_classes=0, gpa_drop=True
    )
