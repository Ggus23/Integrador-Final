...
def get_linear_regression(
    ...
    if current_user.role == models.user.UserRole.ADMIN:
        # Los admins ven el análisis global
        is_psychologist = False
    elif current_user.role == models.user.UserRole.PSYCHOLOGIST:
        is_psychologist = True
    elif current_user.role == models.user.UserRole.STUDENT:
        # Los estudiantes solo ven su propio análisis
        is_psychologist = False
    else:
    ...
    for student in students:
        ...
        latest_pss = (
            ...
            .filter(
                ...
                models.AssessmentResponse.assessment_id == 1,  # PSS-10 es assessment_id=1
            )
        ...
        for grade in subject_grades:
            all_grades.extend([grade.hito2_nota, grade.hito3_nota, grade.hito4_nota, grade.hito5_nota])
    ...
    strength = "fuerte" if abs(r_value) > 0.7 else "moderada" if abs(r_value) > 0.4 else "débil"
