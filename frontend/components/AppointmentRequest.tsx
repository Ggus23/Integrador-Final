...
export function AppointmentRequest() {
    ...
    return (
        <Card className="p-6 border-border bg-card shadow-sm transition-all hover:shadow-md">
            <h3 className="text-xl font-bold font-serif mb-4 text-foreground">Agendar Cita con Psicología</h3>
